...
# ./main.c:21:             fclose(output);
	mov	rax, QWORD PTR -56[rbp]	# tmp128, output
	mov	rdi, rax	#, tmp128
	call	fclose@PLT	#
# ./main.c:22:             return 0;
	mov	eax, 0	# _40,
...
# ./main.c:28:                 fclose(input);
	mov	rax, QWORD PTR -40[rbp]	# tmp131, input
	mov	rdi, rax	#, tmp131
	call	fclose@PLT	#
# ./main.c:29:                 return 0;
	mov	eax, 0	# _40,
...
# ./main.c:31:                 fscanf(input, "%lf", &x);
	...
	mov	rax, QWORD PTR -40[rbp]	# tmp133, input
	lea	rsi, .LC8[rip]	#,
	mov	rdi, rax	#, tmp133
	mov	eax, 0	#,
...
# ./main.c:39:             fprintf(output, "%f", result);
	mov	rdx, QWORD PTR -8[rbp]	# tmp138, result
	mov	rax, QWORD PTR -48[rbp]	# tmp139, output
	movq	xmm0, rdx	#, tmp138
	lea	rsi, .LC9[rip]	#,
	mov	rdi, rax	#, tmp139
	mov	eax, 1	#,
	call	fprintf@PLT	#
...
# ./main.c:53:         printf("Time: %d ms\n", (int) (difftime(t_end, t_start)) / 1000);
	mov	rdx, QWORD PTR -24[rbp]	# tmp144, t_start
	mov	rax, QWORD PTR -32[rbp]	# tmp145, t_end
	mov	rsi, rdx	#, tmp144
	mov	rdi, rax	#, tmp145
	call	difftime@PLT	#
# ./main.c:53:         printf("Time: %d ms\n", (int) (difftime(t_end, t_start)) / 1000);
